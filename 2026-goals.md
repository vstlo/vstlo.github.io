...
- Life long archive and ownership of my data (images, ideas, blog posts, notes, audio, written media, etc)
- Start a public wish list for friends & family
- Publicly write more
- Pursue Canadian citizenship
- Explore Latin American citizenship options
...
- Learn more about RF
- Learn more about distributed sytems
- Maintain a (anonymized) personal website
- Learn to build better software (modularity and encapsulation) particularly in the age of AI
- Get better at gifting
- Remember to *choose* being healthy
- Improve posture
- Focus on strength training again
- Complete major hikes (see list below)
- Run consistently
...
- Refactoring UI
- OS 3 easy steps
- The Jazz Standards by Ted Gloria
- The Staff Engineers Path
- Mathematics it's content methods and meaning
- DDIA
- Understanding Distributed Systems by Roberto V.
- Man and his symbols carl jung
- memories dreams reflections
- OSINT techniques and extreme privacy
- The architecture of OS applications [series](https://aosabook.org/en/)
